...
class MultiheadAttention(Module):
    ...
    def forward(self, query, key, value, key_padding_mask=None, need_weights=True,
                attn_mask=None, gaussian_map=None):
...
# @get_local('attn_outputs_weights')
def multi_head_attention_forward(query: Tensor,
                                 ...
                                 gaussian_map: Optional[Tensor] = None,
    ...
    # add Side directed Gaussian Map
    if gaussian_map is not None:
        attn_output_weights += gaussian_map
    ...
    if need_weights:
        ...
        attn_outputs_weights = attn_output_weights.view(bsz, num_heads, tgt_len, src_len)
        #         return attn_output, attn_output_weights.sum(dim=1) / num_heads
        return attn_output, attn_outputs_weights, q, k
    else:
